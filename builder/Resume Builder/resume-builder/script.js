...
(function ($, window, document, undefined) {
  ...
  Plugin.prototype = {
    init: function () {
      ...
      if (
        thisElement.prop("tagName").toUpperCase() != "INPUT" &&
      ...
      if (
        thisElement.prop("tagName").toUpperCase() === "INPUT" &&
        !settings.typeMatches.test(thisElement.attr("type"))
      ) {
        return;
      }
      ...
      this.inputPaddingTop =
        parseFloat(thisElement.css("padding-top")) +
        parseFloat(settings.paddingOffset);
      thisElement.wrap(
        '<div class="floatlabel-wrapper" style="position:relative"></div>'
      );
      thisElement.before(
        '<label for="' +
          elementID +
          '" class="label-floatlabel ' +
          settings.labelClass +
          " " +
          extraClasses +
          '">' +
    ...
    hideLabel: function () {
      ...
      if (self.settings.slideInput) {
        self.$element.css({
          "padding-top":
            parseFloat(self.inputPaddingTop) -
            parseFloat(this.settings.paddingOffset)
        });
      }
